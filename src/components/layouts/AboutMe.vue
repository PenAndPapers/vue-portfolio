  ...
  <section id="about" class="w-full lg:w-10/12 m-auto transform -rotate-6">
    ...
    <div class="my-32">
      <p class="text-2xl text-center font-extralight">
        ...
        Integer quis auctor elit sed vulputate mi. Pulvinar sapien et ligula ullamcorper malesuada. Lobortis elementum nibh tellus molestie nunc non.
        Sodales ut etiam sit amet. Viverra vitae congue eu consequat. In pellentesque massa placerat duis ultricies lacus sed turpis. Pharetra et ultrices
