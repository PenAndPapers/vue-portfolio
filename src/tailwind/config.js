...
module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      'montserrat-100': ['MontserratThin'],
      'montserrat-200': ['MontserratExtraLight'],
      ...
      'montserrat-800': ['MontserratExtraBold'],
      'montserrat-900': ['MontserratBlack'],
    },
    fontSize: {
